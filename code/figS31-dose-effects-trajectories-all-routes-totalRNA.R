...
# Subset to total RNA data, from relevant tissues, & fixed cofactor set
...
fig.traj.nose <- 
  ...
  labs(x = "Days post infection", y = "Viral titer (log10 total RNA copies)",linetype = "Dose (pfu)") +
...
ggsave("./outputs/figures/figS31-dose-effects-trajectories-all-routes-totalRNA.png",
       plot = fig.traj,
       width = 6, 
       height = 5.2,
       dpi = 600)
